...
# На Render чаще всего надо задать WEBHOOK_BASE вручную:
# WEBHOOK_BASE = https://docsinbox-bot.onrender.com
...
def extract_inn_kpp(text: str) -> Tuple[str, str]:
    ...
    # если цифры не нашли — сохраняем как есть в ИНН, КПП пустой (как ты хотела “как угодно”)
...
async def handle_webhook(request: web.Request):
    try:
        ...
        # важно для aiogram2: установить текущего бота в контекст
        Bot.set_current(bot)
